...
Observar a densidade dos atributos de força dos pokemons ajuda a entender se há alguma variação para esses itens ao longo das gerações. Aqui, duas percepções são importantes. Primeiramente, não há valorização para determinado atributo, em nenhuma geração, isso é importante para entender que os Pokemons seguem em mesmo nível; o segundo ponto é que, 
